                ...
                <div className={classes}>
                    ...
                    <div className="card-body">
                        <div className="card-metadata f_12_14 m_b_10">
                            <a href="/test" className="text-dark mr-4"><i className="fas fa-external-link-alt"></i>Tien Aling</a> 
                            <a href="/test" className="text-dark mx-4"><i className="fas fa-stopwatch"></i>00-22-3333</a>
                            <a href="/test" className="text-dark ml-4"><i className="fas fa-envelope"></i>0</a>
                        </div>
                        <div className="text-title mt-2">
                            <p className="text-muted f_14_20 mb-0">{this.props.data.text} 
                            <a href="/test" className="text-primary m_l_10 f_12_14">Read More.....</a></p>
                        </div>
                    </div>  
                </div>  
