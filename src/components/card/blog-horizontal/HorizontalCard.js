                    ...
                    <div className="row no-gutters">
                        ...
                        <div className="col-12 col-md-8">
                            <div className="card-body">
                                ...
                                <div className="card-title font-weight-bold f_18_22"><a href="/test" class="text-dark">{this.props.data.title}</a></div>
                                <p className="card-text m_b_10 f_12_14"><small className="text-muted"> Tien Nguyen 2 Apr 30, 2015</small></p>
                                <div className="card-text m_b_10 f_14_20">{this.props.data.text} <a href="/test" class="text-primary f_12_14">Read More</a></div>
                            </div>
                        </div>
                    </div>
                </div>
